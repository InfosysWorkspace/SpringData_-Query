package com.infy.SpringDataQueryCreation.repository;
...
public interface CustomerRepository extends CrudRepository<Customer, Integer> {
    ...
    Integer updateCustomerEmailId(@Param("emailId")
                                  String updateCustomerByEmailId, @Param("customerId") Integer customerId);
